...
import kotlinx.android.synthetic.main.custom_note_dialog_view.view.*

@SuppressLint("InflateParams")
class NoteAlertDialog(private val context: Context) {
    private var builder: AlertDialog.Builder
    private var alertDialog: AlertDialog
    private val dialogView by lazy {
        LayoutInflater.from(context).inflate(R.layout.custom_note_dialog_view, null)
    }
    private val titleTextView by lazy { dialogView.titleTextView }
    private val editText by lazy { dialogView.noteEditText }
    ...
    fun rightButton(
        ...
        this.text = text
        setClickListenerToDialogButton {
            onDateSelected.invoke(editText.text.toString())
            alertDialog.dismiss()
        }
    }
