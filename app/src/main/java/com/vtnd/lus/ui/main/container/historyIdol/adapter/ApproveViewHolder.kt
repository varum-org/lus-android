    ...
    override fun bind(item: ItemViewHolder<Order>) {
        ...
        itemView.apply {
            item.itemData.let {
                ...
                text_start_time.text = context.getString(R.string.start_time_output, it.createdDate)
                ...
                GlideApp.with(context)
                    ...
                    .dontAnimate()
                    .into(image_view)
                done_button.safeClick { _ ->
                    onItemClickListener.invoke(HistoryActionType.DONE, it)
                }
            }
        }
    }
